...
import cn.edu.training.novel.service.CoverImageValidator;
...
class CoverUploadServiceTest {
    ...
    void databaseWriteFailureCompensatesTheNewManagedObject() throws Exception {
        ...
        CoverUploadService service = new CoverUploadService(catalogRepository, auditTrail, storage, validator);
        ...
        doThrow(new IllegalStateException("forced database failure")).when(catalogRepository).updateBook(any(Book.class));
